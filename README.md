...
``` bash
curl -s https://raw.githubusercontent.com/mina2047/Hello-odoo14/master/run.sh | sudo bash -s odoo-one 10014 20014
```
...
``` bash
curl -s https://raw.githubusercontent.com/mina2047/Hello-odoo14/master/run.sh | sudo bash -s odoo-two 11014 21014
```
...
``` sh
$ git clone https://github.com/mina2047/Hello-odoo14.git
